...
const TEST_CASES = [
    ...
    },
    {
        ...
        expected: {
            income: 100000,
            C6: 17400.00, // Skala podatkowa
            F6: 15650.00, // Skala podatkowa (IP BOX)
            E6: 22728.90, // Podatek liniowy
            G6: 19228.90, // Podatek liniowy (IP BOX)
            C9: 11540.83, // Ryczałt 2%
            D9: 12694.66, // Ryczałt 3%
            E9: 15579.25, // Ryczałt 5.5%
            F9: 19040.75, // Ryczałt 8.5%
            G9: 19656.09, // Ryczałt 8.5% i 12.5%
            C11: 20771.50, // Ryczałt 10%
    ...
    },
    {
        ...
        expected: {
            income: 100000.00, // Dochód
            C6: 17400.00, // Skala podatkowa
            C6_joint: 17400.00, // Skala podatkowa (wspólne rozliczenie z małżonkiem)
            F6: 13900.00, // Skala podatkowa (IP BOX)
            F6_joint: 13900.00, // Skala podatkowa (IP BOX) (wspólne rozliczenie z małżonkiem)
            E6: 22728.90, // Podatek liniowy
            G6: 15728.90, // Podatek liniowy (IP BOX)
            C9: 12140.83, // Ryczałt 2%
            D9: 13594.66, // Ryczałt 3%
            E9: 17229.25, // Ryczałt 5.5%
            F9: 21590.75, // Ryczałt 8.5%
            G9: 23406.09, // Ryczałt 8.5% i 12.5%
            C11: 23771.50, // Ryczałt 10%
    ...
    },
    {
        ...
        expected: {
            income: 200000,
            C6: 54400.00, // Skala podatkowa
            C6_joint: 38400.00, // Skala podatkowa (wspólne rozliczenie z małżonkiem)
            F6: 31400.00, // Skala podatkowa (IP BOX)
            F6_joint: 31400.00, // Skala podatkowa (IP BOX) (wspólne rozliczenie z małżonkiem)
            E6: 45457.80, // Podatek liniowy
            G6: 31457.80, // Podatek liniowy (IP BOX)
            C9: 13940.83, // Ryczałt 2%
            D9: 16294.66, // Ryczałt 3%
            E9: 22179.25, // Ryczałt 5.5%
            F9: 29240.75, // Ryczałt 8.5%
            G9: 34656.09, // Ryczałt 8.5% i 12.5%
            C11: 32771.50, // Ryczałt 10%
    ...
    },
    {
        ...
        expected: {
            income: 1000000,    
            C6: 382400.00, // Skala podatkowa
            F6: 179900.00, // Skala podatkowa (IP BOX)
            E6: 235916.90, // Podatek liniowy
            G6: 130916.90, // Podatek liniowy (IP BOX)
            C9: 40453.44, // Ryczałt 2%
            D9: 52370.35, // Ryczałt 3%
            E9: 82162.60, // Ryczałt 5.5%
    ...
    },
    {
        ...
        expected: {
            income: 4000000,
            C6: 1732400.00, // Skala podatkowa
            C6_joint: 1687120.00, // Skala podatkowa (wspólne rozliczenie z małżonkiem)
            F6: 1422400.00, // Skala podatkowa (IP BOX)
            F6_joint: 1377120.00, // Skala podatkowa (IP BOX) (wspólne rozliczenie z małżonkiem)
            E6: 1072400.90, // Podatek liniowy
            G6: 892400.90, // Podatek liniowy (IP BOX)
            C9: 96453.44, // Ryczałt 2%
            D9: 136370.35, // Ryczałt 3%
            E9: 236162.60, // Ryczałt 5.5%
...
function compareValues(actual, expected, fieldName) {
    ...
    if (!isClose) {
        console.error(`❌ ${fieldName}: Expected ${expectedNum}, but got ${actualNum} (diff: ${diff})`);
        return false;
    }
    return true;
}
...
async function runTestCase(testCase) {
    ...
    document.getElementById('ipBoxCoeff').value = testCase.input.ipBoxCoeff.toString();
    
    // Handle joint taxation
    const jointTaxationRadio = document.querySelector(`input[name="jointTaxation"][value="${testCase.input.jointTaxation ? 'yes' : 'no'}"]`);
    jointTaxationRadio.checked = true;
    jointTaxationRadio.dispatchEvent(new Event('change'));

    if (testCase.input.jointTaxation) {
        document.getElementById('spouseIncome').value = testCase.input.spouseIncome.toString();
    }
